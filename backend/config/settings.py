...
DATABASES = {
    "default": dj_database_url.config(
        default="postgresql://coalflow:coalflow@db:5432/coalflow",
        conn_max_age=600,
    )
}
...
LANGUAGE_CODE = "en-us"
TIME_ZONE = os.getenv("DJANGO_TIME_ZONE", "Asia/Makassar")
USE_I18N = True
USE_TZ = True
...
CELERY_BEAT_SCHEDULE = {
    "refresh-telemetry-signal-health": {
        "task": "telemetry.refresh_signal_health",
        "schedule": 60.0,
    },
}
