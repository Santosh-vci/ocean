...
_ACTION_DEFINITIONS: Final[tuple[AssistantActionDefinition, ...]] = (
    ...
    _action(
        ...
        "Repair plan conflicts",
        "Open governed conflict repair controls for the current plan recovery path.",
        "/exceptions/center",
        "Repair conflicts",
        ("berau-scheduler", "abl-dispatcher"),
        "schedule.edit",
        True,
        False,
        ("page_card", "checklist", "disabled_reason"),
        "Plan conflict repair requires schedule edit permission and a governed recovery path.",
    ),
    _action(
        "CREATE_SCENARIO",
    ...
    _action(
        ...
        "Review telemetry trust state",
        "Review GPS/AIS source trust, confidence, identity mapping, and quarantine state.",
        "/map/live",
        "Review trust",
        ("abl-dispatcher", "joint-control-tower-manager"),
        "telemetry.view",
        ...
        True,
        ("dashboard", "page_card", "checklist"),
        "Telemetry trust review requires telemetry visibility.",
    ),
    _action(
    ...
    _action(
        ...
        "Create a governed scenario from the selected Phase 5 recovery recommendation before any plan change.",
        "/recovery/recommendations",
        "Test as scenario",
        ("berau-scheduler", "abl-dispatcher"),
        "schedule.edit",
        ...
        "Only actionable, non-dismissed recommendations can be tested as scenarios.",
    ),
    _action(
    ...
    _action(
        ...
        "Review whether the selected recovery option resolves the physical source cause.",
        "/recovery/recommendations",
        "Review validation",
        ("berau-scheduler", "abl-dispatcher", "joint-control-tower-manager"),
        "schedule.view",
        ...
        True,
        ("page_card", "checklist"),
        "Root-cause validation requires schedule visibility and a recovery recommendation.",
    ),
    _action(
        "RUN_PUBLISHABILITY_CHECK",
        "Run publishability check",
        "Review publishability blockers before manual plan publication.",
        "/approvals/publishing",
        ...
        True,
        ("page_card", "checklist"),
        "Publishability review requires schedule visibility and an approval candidate.",
    ),
    _action(
        "REVIEW_GLOBAL_OPTIMIZATION_CANDIDATE",
        "Review global optimization candidate",
        "Review advisory network-wide optimizer candidates and audit lineage.",
        "/optimization/global",
        "Review candidate",
        ("berau-scheduler", "abl-dispatcher", "joint-control-tower-manager"),
        "schedule.view",
        ...
        True,
        ("dashboard", "page_card", "checklist"),
        "Global optimization review requires schedule visibility and generated candidates.",
    ),
    _action(
        "REVIEW_COMMERCIAL_PROJECTION",
        "Review commercial projection",
        "Review customer-safe ETA, laycan, and demurrage exposure projections.",
        ...
        True,
        ("dashboard", "page_card", "checklist"),
        "Commercial projection review requires schedule visibility.",
    ),
    _action(
        "GENERATE_EXPORT",
...
ROUTE_ACTIONS: Final[dict[str, tuple[str, ...]]] = {
    ...
    "/optimization/global": ("REVIEW_GLOBAL_OPTIMIZATION_CANDIDATE",),
    "/commercial/projections": ("REVIEW_COMMERCIAL_PROJECTION",),
    "/map/live": (
        "REVIEW_SIGNAL_HEALTH",
        "REVIEW_TELEMETRY_TRUST_STATE",
        "OPEN_EXCEPTION_CENTER",
