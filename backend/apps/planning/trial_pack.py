...
def operator_happy_path_demand_rows() -> list[dict]:
    ...
    return [
        ...
        },
        {
            ...
            "next_blocking_constraint": "Ready for scheduling",
            "cargo_requirements": [
                _requirement("SUNGKAI", "LOC-LATI-PORT", "JTY-LATI", 52000, 0, 0),
                _requirement("AGATHIS", "LOC-LATI-PORT", "JTY-LATI", 44000, 0, 0),
            ],
            "cargo_layers": [
                _layer("SUNGKAI", 1, 1, 1, 52000, 52000, "BRG-VAL-08", "JTY-LATI", "CTS-JAVA", "planned", "", "READY", False, iso(3, 10), iso(3, 16)),
            ],
        },
        {
            ...
            "next_blocking_constraint": "Ready for scheduling",
            "cargo_requirements": [
                _requirement("EBONY", "LOC-SAMBARATA-PORT", "JTY-SUARAN", 132000, 0, 0),
            ],
            "cargo_layers": [
                _layer("EBONY", 1, 1, 1, 66000, 66000, "BRG-NUS-17", "JTY-SUARAN", "CTS-BORNEO", "planned", "", "READY", False, iso(4, 14), iso(4, 22)),
            ],
        },
        {
            ...
            "next_blocking_constraint": "Ready for scheduling",
            "cargo_requirements": [
                _requirement("MAHONI", "LOC-SUARAN-PORT", "JTY-SUARAN", 118000, 0, 0),
            ],
            "cargo_layers": [
                _layer("MAHONI", 1, 1, 1, 59000, 59000, "BRG-VAL-08", "JTY-SUARAN", "CTS-JAVA", "planned", "", "READY", False, iso(5, 6), iso(5, 14)),
            ],
        },
    ]
